  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Gérez les conducteurs et leur statut d'activité</p>
      </div>
      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent"
            value={searchTerm}
