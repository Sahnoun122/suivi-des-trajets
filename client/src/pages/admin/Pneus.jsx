  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {pneus.length > 0 ? (
          pneus.map((pneu) => (
            <div key={pneu._id} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow">
              <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                <div className="flex justify-between items-start">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-900">{pneu.numeroSerie || 'N/A'}</h3>
                      <p className="text-sm text-gray-500">{pneu.marque || 'Marque non définie'}</p>
                    </div>
                  </div>
                  <span className={`inline-flex px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(pneu.statut)}`}>
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Kilémétrage</p>
